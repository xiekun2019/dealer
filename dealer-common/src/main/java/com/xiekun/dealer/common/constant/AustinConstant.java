package com.xiekun.dealer.common.constant;
...
public class AustinConstant {
     ...
     */
    public static final String DEFAULT_CREATOR = "xiekun";
    public static final String DEFAULT_UPDATER = "xiekun";
    public static final String DEFAULT_TEAM = "xiekun's team";
    public static final String DEFAULT_AUDITOR = "xiekun";
}